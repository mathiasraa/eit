...
export function characterSelectionPhase(
  gameState: GameState,
  ...
  return (
    <div>
      ...
      <p className="mb-6 text-slate-300">
        The demographic profile you choose will affect your starting budget and
        may influence other aspects of your experience. Different characters
        represent various socioeconomic groups from Nepal during the 2015
        earthquake.
      </p>
