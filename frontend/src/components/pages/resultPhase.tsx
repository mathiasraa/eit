            ...
            <div>
              ...
              <div className="font-medium">
                {Object.keys(buildingSizeTypes).find(
                  (key) => buildingSizeTypes[key as keyof typeof buildingSizeTypes] === gameState.buildingSize
                )}
              </div>
            </div>
            <div>
              ...
              <div className="font-medium">
                {Object.keys(buildingTypes).find(
                  (key) => buildingTypes[key as keyof typeof buildingTypes] ===
        ...
        <div className="bg-slate-700 p-5 rounded-lg mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="h-4 bg-slate-800 rounded-full overflow-hidden">
              <div
                className={`h-full ${(gameState.survivalProbability || 0) > 0.7
                  ? "bg-green-500"
