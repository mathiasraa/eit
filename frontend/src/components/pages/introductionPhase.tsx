    ...
    <div className="bg-slate-800 p-8 rounded-xl shadow-lg">
      ...
      <div className="mb-6 flex flex-col md:flex-row gap-6">
        <div className="flex-1">
          ...
          <p className="mb-4">
            In this simulation, you will make critical decisions about building
            construction and resource allocation that could affect survival
            outcomes during a similar earthquake scenario.
          </p>
          <p className="mb-4">
            ...
            realistic feedback on the potential consequences of your choices.
          </p>
          <p>
      ...
      <div className="bg-slate-700 p-4 rounded-lg mt-6">
        ...
        <p>
          ...
          simulated earthquake. Your choices will be analyzed using real-world
          data to determine likely outcomes.
        </p>
      </div>
    </div>
  );
